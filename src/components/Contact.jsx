        ...
        <form className="space-y-6" noValidate>
          <div>
            ...
            <input
              ...
              autoComplete="name"
              className="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-4 focus:ring-indigo-300 transition"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm resize-none focus:outline-none focus:ring-4 focus:ring-indigo-300 transition"
              required
            ></textarea>
          </div>
